...
After marking a subtask done, check if ALL sibling subtasks are complete:
...
**IMPORTANT**: Do NOT batch status updates. Update tasks.md after EACH task completion.
